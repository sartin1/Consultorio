...
<div class="container-fluid" style="margin-top: 10px; margin-bottom: 10px;">
   ...
   <div class="row">
      ...
      <div class="col-sm-4 col-xs-6 text-right">
         <a id="b_buscar_lineas" class="btn btn-sm btn-info" title=" Buscar por precio predeterminado">
            <span class="glyphicon glyphicon-search"></span> &nbsp; Buscar por precio predeterminado
         </a>
         <div class="btn-group">
         ...
         <div class="col-sm-3">
            <div class="form-group">
               <div class="input-group">
                  ...
                  <input class="form-control" type="text" name="ac_cliente" value="<?php echo $fsc->cliente->nombre;?>" id="ac_cliente" placeholder="Cualquier paciente" autocomplete="off"/>
                  <?php }else{ ?>

                  <input class="form-control" type="text" name="ac_cliente" id="ac_cliente" placeholder="Cualquier paciente" autocomplete="off"/>
                  <?php } ?>
  ...
  <table class="table table-hover">
      <thead>
         <tr>
            ...
            <th class="text-left" style="display:none">Prioridad</th>
      ...
      <tr class="clickableRow" href="<?php echo $value1->url();?>" style="background-color: #<?php echo $value1->color_estado();?>">
         <td class="text-center">
            ...
            <span class="glyphicon glyphicon-paperclip" title="El Turno tiene vinculado un <?php  echo FS_ALBARAN;?>"></span>
            <?php } ?>
      ...
      <tr class="warning">
         <td></td>
         <td colspan="9">Ningún Turno encontrado. Pulsa el botón <b>Nuevo</b> para crear uno.</td>
      </tr>
      <?php } ?>
      ...
      <div class="modal-dialog" style="width: 99%; max-width: 950px;">
         <div class="modal-content">
            <div class="modal-header">
               ...
               <h4 class="modal-title"> Buscar por precio predeterminado</h4>
               <?php if( $fsc->cliente ){ ?>
               ...
               <p class="help-block">Si quieres, puede <a href="<?php echo $fsc->url();?>&mostrar=buscar">filtrar por paciente</a>.</p>
               <?php } ?>
