 ...
 * @author carlos
 */
class imprimir_rapido_horizontal4 extends fs_controller
{
   public $agente;
   public $empresa;
   public $servicio;
   ...
   {
      parent::__construct(__CLASS__, 'Imprimir Rápido Horizontal a4', 'Servicio', FALSE, FALSE);
   }
     ...
     private function share_extensions()
  {
      $extensiones = array(
        array(
              ...
              'type' => 'pdf',
              'text' => 'Imprimir recetarios En A4',
              'params' => ''
          ),
     );
