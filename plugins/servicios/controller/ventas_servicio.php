...
class ventas_servicio extends fs_controller
{
   ...
   protected function private_core()
   {
      ...
      if($this->servicio)
      {
         ...
         $this->new_error_msg("¡Turno de paciente no encontrado!");
   }
   ...
   private function modificar()
   {
      ...
      if( $this->servicio->editable() )
      {
         ...
         if ($_POST['cliente'] != $this->servicio->codcliente OR $this->servicio->cifnif == '')
         {
            ...
            if ($cliente)
            {
               ...
               die('No se ha encontrado el paciente.');
         }
         else
         {
      ...
      {
         $this->new_message("Turno modificado correctamente.");
         $this->new_change('Turno Paciente ' . $this->servicio->codigo, $this->servicio->url());
      }
      else
         $this->new_error_msg("¡Imposible modificar el Turno!");
   ...
   private function generar_albaran()
   {
      ...
      $albaran->observaciones = "Turno: ".$this->servicio->codigo." | Fecha: ".$this->servicio->fecha
              ."\nDiagnóstico: ".$this->servicio->descripcion."\nTratamiento: ". $this->servicio->solucion
