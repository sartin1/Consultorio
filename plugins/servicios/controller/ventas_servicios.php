...
class ventas_servicios extends fs_controller
{
   ...
   {
      parent::__construct(__CLASS__,'Turnos a pacientes', 'turnos');
   }
  ...
  public function buscar_lineas()
   ...
   private function delete_servicio()
   {
      ...
      if ($serv1)
      {
         if ($serv1->delete())
         {
            $this->new_message("Turno" . ' ' . $serv1->codigo . " borrado correctamente.");
         }
         else
            $this->new_error_msg("¡Imposible borrar el Turno!");
      }
      else
         $this->new_error_msg("¡Turno no encontrado!");
   }
   ...
   private function share_extension()
   {
      ...
      $extensiones = array(
          array(
              ...
              'type' => 'button',
              'text' => '<span class="glyphicon glyphicon-list" aria-hidden="true"></span> &nbsp; Turno',
              'params' => ''
          ),
          array(
              ...
              'type' => 'button',
              'text' => '<span class="glyphicon glyphicon-list" aria-hidden="true"></span> &nbsp; Turnos de paciente',
              'params' => ''
          ),
          array(
