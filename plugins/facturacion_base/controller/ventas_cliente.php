...
class ventas_cliente extends fs_controller
{
   ...
   {
      parent::__construct(__CLASS__, 'Pacientes', 'ventas', FALSE, FALSE);
   }
   ...
   protected function private_core()
   {
      ...
      else if( isset($_POST['codcliente']) ) /// modificar cliente
      {
         ...
         $this->cliente->pnacimiento = $_POST['pnacimiento'];
         $this->cliente->egestacional = $_POST['egestacional'];
         $this->cliente->antpre = $_POST['antpre'];
         $this->cliente->antfam = $_POST['antfam'];
         $this->cliente->antper = $_POST['antper'];
         $this->cliente->observaciones = $_POST['observaciones'];
              $this->cliente->sexo = $_POST['sexo'];
                   $this->cliente->edad = $_POST['edad'];
                   $this->cliente->fnac = $_POST['fnac'];
         ...
         {
            $this->new_message("Datos del paciente modificados correctamente.");
         }
         else
            $this->new_error_msg("¡Imposible modificar los datos del paciente!");
      }
