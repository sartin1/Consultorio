...
class ventas_facturas extends fs_controller
{
   ...
   {
      parent::__construct(__CLASS__, ucfirst(FS_FACTURAS).' de pacientes', 'turnos');
   }
   ...
   private function share_extension()
   {
      ...
      $extensiones = array(
          ...
          array(
              ...
              'type' => 'button',
              'text' => '<span class="glyphicon glyphicon-list" aria-hidden="true"></span> &nbsp; Facturas de pacientes',
              'params' => ''
          ),
          array(
