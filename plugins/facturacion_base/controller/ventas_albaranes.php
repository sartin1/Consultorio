...
class ventas_albaranes extends fs_controller
{
   ...
   {
      parent::__construct(__CLASS__, ucfirst(FS_ALBARANES).' de pacientes', 'turnos', FALSE, TRUE, TRUE);
   }
   ...
   private function share_extension()
   {
      ...
      $extensiones = array(
          ...
          array(
              ...
              'type' => 'button',
              'text' => '<span class="glyphicon glyphicon-list" aria-hidden="true"></span> &nbsp; '.ucfirst(FS_ALBARANES).' de paciente',
              'params' => ''
          ),
          array(
