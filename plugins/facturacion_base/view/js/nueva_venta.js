...
function recalcular()
{
   ...
   $("#price").val( neto + total_iva - total_irpf + total_recargo );
            ...
            $.each(json, function(key, val) {
               ...
               if( val.sevende && (val.stockalm > 0 || val.controlstock) )
               {
                  ...
                  items.push(tr_aux+"<td><a href=\"#\" onclick=\"get_precios('"+val.referencia+"')\" title=\"más detalles\">\n\
                     ...
                     &nbsp; <a href=\"#\" onclick=\"return "+funcion+"\">"+val.referencia+' '+val.descripcion+"</a></td>\n\
               ...
               else if(val.sevende)
               {
                  items.push(tr_aux+"<td><a href=\"#\" onclick=\"get_precios('"+val.referencia+"')\" title=\"más detalles\">\n\
                     <span class=\"glyphicon glyphicon-eye-open\"></span></a>\n\
                     &nbsp; <a href=\"#\" onclick=\"alert('Sin stock.')\">"+val.referencia+' '+val.descripcion+"</a></td>\n\
