...
<head>
   ...
   <title>Sartin Soft</title>
   <meta name="description" content="Sartin Soft es un software de facturación y contabilidad para pymes." />
...
<body>
   <nav class="navbar navbar-default" role="navigation" style="margin: 0px;">
      <div class="container-fluid">
         <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.php">Sartin Soft</a>
         </div>
   ...
   <form name="f_feedback" action="" method="post" target="_blank" class="form" role="form">
   ...
   <div class="container">
      <div class="row">
         <div class="col-lg-12">
            <div class="page-header">
               <h1>Bienvenido al instalador de Sartin Soft <?php echo file_get_contents('VERSION'); ?></h1>
            </div>
         </div>
      </div>
         ...
         <div class="col-lg-12">
            ...
            <div class="panel panel-danger">
               ...
               <div class="panel-body">
                  <p>
                     La carpeta de Sartin Soft no tiene permisos de escritura. Sin esos
                     permisos, no funcionará Sartin Soft.
                  </p>
            ...
            <div class="panel panel-danger">
               ...
               <div class="panel-body">
                  <p>
                     Sartin Soft necesita PHP 5.3 o superior, y tú estás usando <?php echo phpversion() ?>.
                  </p>
            ...
            <div class="panel panel-danger">
               ...
               <div class="panel-body">
                  <p>
                     Sartin Soft necesita la extensión mbstring para poder trabajar con caracteres
                  ...
                  <p>
                     ...
                     Es mejor que busques un proveedor de hosting más completo.
                  </p>
               </div>
            </div>
                  <?php
            ...
            <div class="panel panel-danger">
               ...
               <div class="panel-body">
                  <p>
                     Sartin Soft necesita la extensión OpenSSL para poder descargar plugins,
      ...
      <div class="row">
         <div class="col-lg-10">
            ...
            <p>
               Recorda! acá tenes mi numero telefónico (2974769711) por si tenes alguna duda para la instalación de Sartin Soft. Pero es una instalación súper sencilla
			   te va a costar mucho perderte, con sólo seguir los pasos el sistema funcionará correctamente :).
            </p>
            <p>
               Si queres una instalación asistida comunicate conmigo para poder coordinar! Suerte!
            </p>
