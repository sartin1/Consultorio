...
<div class="btn-group  pull-right">
	<a href="index.php?view=newproduct" class="btn btn-default">Agregar Jugador</a>
<div class="btn-group pull-right">
...
<div class="clearfix"></div>
	...
	<div class="jumbotron">
		...
		<p>No se han agregado jugadores a la base de datos, puedes agregar uno dando click en el boton <b>"Agregar Jugador"</b>.</p>
	</div>
	<?php
}
